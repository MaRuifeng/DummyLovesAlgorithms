...
public class MinimumSetPartition extends FunIntAlgorithm {
	 ...
	 * minimum sum difference with its compensating partner. If A[n-1] is included, mark subset (single element) sum as A[n-1] and continue looking
	 * in array A(n-1); if A[n-1] is not included, mark subset (null set) sum as 0 and continue looking in array A(n-1); repeat until the array
	 * is depleted. 
	 */
